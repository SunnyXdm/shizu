...
const MobileInput = ({
    ...
    return (
        <View
            ...
            <View style={[
                {
                    backgroundColor: country || countryFocus ? 'black' : colors.inactiveBackground,
                    padding: 10,
                    borderRadius: 10,
                    borderWidth: 1,
                    ...
                    style={[
                        {
                            ...
                            // width: '100%',
                            padding: 10,
                            fontWeight: country || countryFocus ? 'bold' : '400',
                            // backgroundColor: "red"
                        },
                        inputStyles,
                    ]}
            ...
            <View style={[
                {
                    width: '79%',
                    backgroundColor: mobile || mobileFocus ? 'black' : colors.inactiveBackground,
                    padding: 10,
                    borderRadius: 10,
                    borderWidth: 1,
                    borderColor: colors.border,
